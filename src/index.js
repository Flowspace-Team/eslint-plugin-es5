...
module.exports = {
  configs: {
    'no-es2015': {
      ...
      rules: {
        'flowspace-es5/no-arrow-functions': 2,
        'flowspace-es5/no-binary-and-octal-literals': 2,
        'flowspace-es5/no-block-scoping': 2,
        'flowspace-es5/no-classes': 2,
        'flowspace-es5/no-computed-properties': 2,
        'flowspace-es5/no-default-parameters': 2,
        'flowspace-es5/no-destructuring': 2,
        'flowspace-es5/no-es6-methods': 2,
        'flowspace-es5/no-es6-static-methods': 2,
        'flowspace-es5/no-for-of': 2,
        'flowspace-es5/no-generators': 2,
        'flowspace-es5/no-modules': 2,
        'flowspace-es5/no-object-super': 2,
        'flowspace-es5/no-rest-parameters': 2,
        'flowspace-es5/no-shorthand-properties': 2,
        'flowspace-es5/no-spread': 2,
        'flowspace-es5/no-template-literals': 2,
        'flowspace-es5/no-typeof-symbol': 2,
        'flowspace-es5/no-unicode-code-point-escape': 2,
        'flowspace-es5/no-unicode-regex': 2
      }
    },
    'no-es2016': {
      plugins: [
      ...
      rules: {
        'flowspace-es5/no-exponentiation-operator': 2
      }
    }
  },
  rules: {
